...
/***/ function(module, exports) {
	...
	(function (global, factory) {
	    ...
	    //弹窗调用
	    plus._alert = function (option) {
	        new _Alert(option);
	    };

	    //获取URL上参数
	    plus._getUrlParam = function (name) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @param {Object} options
	 * @return {*}
	 */function coerceProp(prop,value,vm){var coerce=prop.options.coerce;if(!coerce){return value;}if(typeof coerce==='function'){return coerce(value);}else{process.env.NODE_ENV!=='production'&&warn('Invalid coerce for prop "'+prop.name+'": expected function, got '+typeof coerce+'.',vm);return value;}}/**
